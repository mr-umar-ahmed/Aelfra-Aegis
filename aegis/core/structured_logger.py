"""
Aelfra Aegis — SIEM-Compatible Structured Logger
Emits self-contained, append-only JSON Lines (JSONL) events to <data_dir>/audit/aegis-YYYY-MM-DD.jsonl.
...
class StructuredLogger:
    def __init__(self, audit_dir: Optional[str] = None):
        self.audit_dir = os.path.abspath(audit_dir or get_audit_dir())
    ...
    def _get_current_log_path(self) -> str:
        ...
        Rotates automatically when UTC midnight passes.
        """
